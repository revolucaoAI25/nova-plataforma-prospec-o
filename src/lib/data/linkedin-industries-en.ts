// Rótulo em INGLÊS de cada indústria do LinkedIn (id -> label), só pra uso
// server-side em src/lib/integrations/linkedin.ts — reforça a busca via
// searchQuery (texto livre, fuzzy) somando o nome do setor em inglês (como o
// LinkedIn indexa) quando o usuário filtra por indústria. A UI mostra o
// rótulo traduzido (src/lib/data/linkedin-industries.ts); este arquivo é só
// o texto original, nunca exibido — por isso fica fora do bundle do cliente
// (não é importado por nenhum componente "use client").
export const LINKEDIN_INDUSTRY_LABEL_EN: Record<string, string> = {
