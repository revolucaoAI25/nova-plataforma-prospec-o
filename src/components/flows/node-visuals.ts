import {
  CalendarClock, Filter, Sheet, FileSpreadsheet, Play, Building2, MapPin, AtSign,
  UserSearch, History, BrainCircuit, Send, Mail, type LucideIcon,
} from "lucide-react";
...
export const FLOW_NODE_ICONS: Record<LucideIconName, LucideIcon> = {
  CalendarClock, Filter, Sheet, FileSpreadsheet, Play, Building2, MapPin, AtSign,
  UserSearch, History, BrainCircuit, Send, Mail,
};
